...
import 'package:e_commerce_site_django/src/addresses/models/create_address_model.dart';
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: List.generate(
                    addressNotifier.adddressTypes.length,
                    (index) {
                      final addressType = addressNotifier.adddressTypes[index];
                      return GestureDetector(
                        onTap: () {
                          addressNotifier.setAddressType(
                              addressNotifier.adddressTypes[index]);
                        },
                        child: Container(
