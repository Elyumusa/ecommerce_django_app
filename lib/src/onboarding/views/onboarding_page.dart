...
import 'package:e_commerce_site_django/src/onboarding/widgets/onboarding_page_one.dart';
import 'package:e_commerce_site_django/src/onboarding/widgets/onboarding_page_two.dart';
import 'package:e_commerce_site_django/src/onboarding/widgets/welcome_screen.dart';
      ...
      body: Stack(
        children: [
          PageView(
            ...
            onPageChanged: (value) {
              context.read<OnboardingNotifier>().setSelectedPage = value;
            },
            children: const [
              OnBoardingScreenOne(),
              OnBoardingScreenTwo(),
